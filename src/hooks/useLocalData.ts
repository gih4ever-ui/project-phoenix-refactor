...
export const useLocalData = (initialData?: FluctusData) => {
  ...
  return { data, cloudReady, syncStatus, add, update, remove, updateFixedCosts, addLogisticsDeposit, removeLogisticsDeposit, recalculateLogisticsFund, recalculateAllTotals, confirmLogisticsExpense, unconfirmLogisticsExpense, seed, backup, restore };
};
